              	 ...
              	 | //iso:*[@id= $fragment-id ]" />
						...
						<xsl:for-each select="$theDocument_1">
              			...
              			$theDocument_1//iso:*[@id= $fragment-id ]" />
							...
							<xsl:choose>
								...
								<!-- case 2 -->
								<xsl:when
									test=" $theFragment_1/cls::iso:schema ">
									<xsl:message>
					...
					<xsl:otherwise>
						...
						<xsl:choose>
							...
							<!-- case 2 -->
							<xsl:when
								test=" $theFragment_2/cls::iso:schema or $theContainedFragments/cls::iso:schema">
								<xsl:message>
			...
			<xsl:otherwise>
				<xsl:choose>
              	...
              	$theDocument_1//schold:*[@id= $fragment-id ]" />
							<xsl:if
								test=" $theFragment_1/cls::schold:schema ">
								<xsl:message>
									Schema error: Use include to include
									fragments, not a whole schema
								</xsl:message>
					...
					<xsl:otherwise>
						...
						<xsl:if
							test=" $theFragment_2/cls::schold:schema or $theContainedFragments/cls::schold:schema">
							<xsl:message>
								Schema error: Use include to include
								fragments, not a whole schema
							</xsl:message>
